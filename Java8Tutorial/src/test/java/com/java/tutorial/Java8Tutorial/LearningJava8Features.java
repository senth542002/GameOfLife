...
public class LearningJava8Features {
	...
	@Test
	public void localDateTimeUsageInJava8() throws Exception {
		LocalDateTime sylverster = LocalDateTime.of(2016, Month.DECEMBER, 31, 23, 59, 59);
		DayOfWeek dayOfTheWeek = sylverster.getDayOfWeek();
		System.out.println(dayOfTheWeek); 
		System.out.println(sylverster.getMonth());
		System.out.println(sylverster.getLong(ChronoField.MINUTE_OF_DAY));
		
		Instant instant = sylverster.atZone(ZoneId.systemDefault()).toInstant();
